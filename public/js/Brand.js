...
let BRAND = {
    app: {
        language: 'en',
        name: 'Vraica Connect',
        title: 'Cover Pilot<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
            'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
        joinDescription: 'Vraica',
        joinButtonLabel: 'JOIN ROOM',
        joinLastLabel: 'Your recent room:',
    },
    site: {
        title: 'Vraica Connect',
    ...
    meta: {
        description:
            'Vraica Connect powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
        keywords:
    ...
    about: {
        ...
        html: `
            ...
            <br /><br />
            <hr />
            <span>&copy; 2025 Vraica connect, all rights reserved</span>
            <hr />
        `,
    },
    //...
