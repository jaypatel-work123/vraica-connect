...
module.exports = {
    ...
    integrations: {
        ...
        videoAI: {
            ...
            systemLimit: process.env.VIDEOAI_SYSTEM_LIMIT || 'You are a streaming avatar from Vraica connect...',
        },
    ...
    ui: {
        ...
        brand: {
            ...
            app: {
                ...
                name: process.env.APP_NAME || 'Vraica connect',
                title:
                    process.env.APP_TITLE ||
                    '<h1>Vraica connect</h1> Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
                    process.env.APP_DESCRIPTION ||
                    'Start your next video call with a single click. No download, plug-in, or login is required.',
                joinDescription: process.env.JOIN_DESCRIPTION || 'Vraica',
             ...
             */
            site: {
                title: process.env.SITE_TITLE || 'Vraica connect, Free Video Calls, Messaging and Screen Sharing',
            ...
            meta: {
                description:
                    ...
                    'Vraica connect powered by WebRTC and mediasoup for real-time video communications.',
                keywords: process.env.META_KEYWORDS || 'webrtc, video calls, conference, screen sharing, vraica connect, sfu',
            },
            ...
            og: {
                ...
                siteName: process.env.OG_SITE_NAME || 'Vraica connect',
                title: process.env.OG_TITLE || 'Click the link to make a call.',
                description:
                    process.env.OG_DESCRIPTION || 'Vraica connect provides real-time video calls and screen sharing.',
            ...
            about: {
                ...
                html: `
                    ...
                    <hr />
                    <span>
                        &copy; ${new Date().getFullYear()} ${process.env.COPYRIGHT_TEXT || 'Vraica connect, all rights reserved'}
                    </span>
                    <hr />
                    `,
            },
